  ...
  <div class="home">
    <div ref="banner" class="banner content-item-block">
      ...
      <h1 class="banner-title">
        Welcome to Our Job Recommendation System
        <div class="subTitle">UNIMPEDED</div>
      </h1>
      <div class="search">
        <input-search
          @search="searchJobs"
    ...
    <!-- 产品 -->
    <div class="main" ref='li'>
      <!-- 职位 -->
      <div class="job-category content-item-block">
        <h2 class="job-category-title title">帮助你找到最适合的职位</h2>
